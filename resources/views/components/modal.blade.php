...
>
    ...
    <div x-show="show" class="mb-6 bg-body-light dark:bg-body-dark dark:text-white text-slate-900 rounded-3xl overflow-hidden transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
